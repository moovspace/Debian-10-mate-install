...
function activate(context) {
    let disposable = vscode.commands.registerCommand('extension.sayHello', () => {
        ...
        function updateDecorations() {
            ...
            const preclass_text = editor.document.getText(new vscode.Range(new vscode.Position(0, 0), new vscode.Position(line, 0)));
            const text = editor.document.getText(new vscode.Range(new vscode.Position(line, 0), new vscode.Position(editor.document.lineCount, 0)));
            let smallNumbers = [];
            let match;
